...
InternalUseOnly_sql <- paste0("
  SELECT *
  FROM InternalUseOnlys_derived
  WHERE InternalUseOnly_snapshot_date = (
  SELECT MAX(InternalUseOnly_snapshot_date)
  FROM InternalUseOnlycases_derived)
